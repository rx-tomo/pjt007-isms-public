...
残るズレは、承認キューの行レベルで業務名、変更概要、申請者、影響を十分に解決できていないこと、ホーム下部のカード群にまだ重複が残ること、審査準備パッケージやホームの一部文言が自然な利用者語へ完全には寄り切っていないことである。これらは `PRFAQ-BL-27`、`PRFAQ-BL-28`、`PRFAQ-BL-33`〜`PRFAQ-BL-35` として継続する。
