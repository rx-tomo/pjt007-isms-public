      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <span className="text-xl font-bold text-text-primary whitespace-nowrap">{t('common.appName')}</span>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="md:hidden p-2 rounded-lg hover:bg-surface-elevated transition-colors duration-200 shrink-0"
