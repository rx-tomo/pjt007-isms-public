    ...
    <div className="relative bg-surface/70 backdrop-blur-md rounded-2xl p-5 border border-border shadow-lg transition-all duration-300 hover:shadow-xl">
      ...
      <div className="space-y-2.5">
        ...
        <div className="flex gap-2 mt-3">
          <input
            type="text"
            className="flex-1 text-sm bg-surface/70 border border-border rounded-lg px-4 py-2.5 shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 disabled:opacity-50"
          ...
          <button
            ...
            disabled={isSaving}
            onClick={onAdd}
            className="inline-flex items-center px-4 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white text-sm font-medium rounded-lg shadow-md hover:from-blue-600 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function ISMSScopeSettings({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-6 p-5 bg-gradient-to-br from-blue-50 to-blue-100 rounded-2xl border border-blue-100/50">
        <div className="flex">
