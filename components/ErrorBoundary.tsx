        ...
        <div className="bg-surface py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6 space-y-4">
            <button
              ...
              className="w-full flex justify-center py-2 px-4 border border-border rounded-md shadow-sm bg-surface text-sm font-medium text-text-secondary hover:bg-surface-elevated focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
