...
function schemaStatements() {
  return [
    ...
    {
      sql: `create trigger if not exists residual_acceptance_approval_bindings_immutable
    ...
    {
      sql: `create trigger if not exists residual_acceptance_approval_bindings_delete_guard
